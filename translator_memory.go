...
func (this memTranslator) ResolveStruct(s interface{}, locale string, key string, field string) string {
...
func (this memTranslator) TranslateStruct(s interface{}, locale string, key string, field string, placeholders map[string]string) string {
